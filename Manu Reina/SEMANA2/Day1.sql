...
SELECT 
    ...
    ,TRUNC(COALESCE((B.NUMERO_PEDIDOS_COMPLETADOS/A.PEDIDOS_TOTALES)*100,0),2) AS PCT_PEDIDOS_EXITOSOS
    ,TRUNC(COALESCE((NUM_PIZZAS_MODIF/C.NUM_PIZZAS) * 100, 0),2) AS PCT_PIZZAS_MODIF
